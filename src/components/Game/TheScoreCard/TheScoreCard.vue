<template>
  <q-markup-table class="the-score-card" dense>
    <thead>
      <tr class="text-bold">
        <th></th>

        <th>
          <Text size="sm" class="text-center relative-position q-pa-md">
            {{ left.name }}
    ...
    <tbody>
      <tr>
        ...
        <td class="text-center">
          <Reason v-if="left.name === winner" :value="victory" />
        </td>
        <td class="text-center">
          <Reason v-if="right.name === winner" :value="victory" />
        </td>
      </tr>
      ...
      <tr class="rating">
        ...
        <td class="text-center">
          <Text v-if="right.name !== botNickname" size="sm">
            {{ leftRatingPoints }}
          </Text>
        </td>
        <td class="text-center">
      ...
      <tr>
        <td>
          <div class="row justify-center">
            <CardIcon :group="CardGroupId.civilian" :size="smIconSize" />
          </div>
        </td>
        <td class="text-center">
          <Text size="sm">
      ...
      <tr>
        <td>
          <div class="row justify-center">
            <CardIcon :group="CardGroupId.scientific" :size="smIconSize" />
          </div>
        </td>
        <td class="text-center">
          <Text size="sm">
      ...
      <tr>
        <td>
          <div class="row justify-center">
            <CardIcon :group="CardGroupId.commercial" :size="smIconSize" />
          </div>
        </td>
        <td class="text-center">
          <Text size="sm">
      ...
      <tr>
        <td>
          <div class="row justify-center">
            <CardIcon :group="CardGroupId.guild" :size="smIconSize" />
          </div>
        </td>
        <td class="text-center">
          <Text size="sm">
...
const { winner, victory } = $game.state;
const ratingPoints = $game.players[winner as Nickname].points;
const leftRatingPoints =
  left.name === winner ? `+${ratingPoints}` : `-${ratingPoints}`;
const rightRatingPoints =
  right.name === winner ? `+${ratingPoints}` : `-${ratingPoints}`;
</script>
