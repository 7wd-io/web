...
export default class Board {
  ...
  static getWonder(id: WonderId) {
    return document.querySelector(
      `.${Board.getClassnameWonder(id)}`
    ) as HTMLElement;
  }

  static getCard(id: CardId) {
    return document.querySelector(
      `.${Board.getClassnameCard(id)}`
    ) as HTMLElement;
  }

  static getToken(id: TokenId) {
    return document.querySelector(
      `.${Board.getClassnameToken(id)}`
    ) as HTMLElement;
  }

  static getDiscard() {
    return document.querySelector(`.${Board.classnameDiscard}`) as HTMLElement;
  }

  static getDiscardCardHolder() {
    return document.querySelector(
      `.${Board.classnameDiscardCardHolder}`
    ) as HTMLElement;
  }
}
